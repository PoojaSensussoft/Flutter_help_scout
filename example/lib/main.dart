...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //String beaconId = '215bfd00-95b7-489b-bcd6-5400cd9a7a94';

  // Platform messages are asynchronous, so we initialize in an async method.
  Future<void> initBeacon() async {
    _beacon = FlutterHelpScout(
        beaconId: "215bfd00-95b7-489b-bcd6-5400cd9a7a94",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        ...
        // color: Colors.blue,
        onPressed: () {
          _beacon!.open(beaconId: "215bfd00-95b7-489b-bcd6-5400cd9a7a94");
        },
      )),
    );
  }
